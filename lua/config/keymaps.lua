---------------------------------------------------------------------------------------------------
-- NeoVim keymaps
-- Sets some quality-of-life keymaps
---------------------------------------------------------------------------------------------------
...
-- Dashboard
vim.keymap.set("n", "<leader>a", "<Cmd>Dashboard<CR>", { desc = "Go to dashboard" })
...
-- File Explorer
vim.keymap.set("n", "<leader>m", "<Cmd>NvimTreeFocus<CR>", { desc = "Focus on File tree" })
