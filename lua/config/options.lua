...
vim.opt.showmode = false -- Don't show mode in comand line
...
vim.opt.redrawtime = 10000 -- Timeout for syntaz highlighting redraw
...
vim.opt.timeoutlen = 500 -- Time in ms to wait for mapped swquence
...
vim.opt.iskeyword:append("-") -- Treat dash as apart of a word
